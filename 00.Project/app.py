...
carcent_list = pd.read_csv('C:/Workspace/01.PythonWeb/00.Project/static/광주_자동차정비업체.csv')
...
def input():
    if request.method == 'POST':
        ...
        map.save('C:/WorkSpace/01.PythonWeb/00.Project/static/marker.html')
...
@app.route('/expendables', methods=['GET','POST'])
def expend_list():
    return render_template('expendables.html')
